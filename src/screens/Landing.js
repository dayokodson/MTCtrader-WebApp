                                    ...
                                    <div className="col-12 px-0 align-self-center">
                                        <div className="row mx-0">
                                            ...
                                            <div className="col-10 col-md-8 col-lg-4  col-ld-6 mx-auto">
                                                <h1 className="mb-4"><span className="text-secondary fw-light">
                                                    Crypto<br/>Forecast</span><br/>
                                                    on the go!
                                                </h1>
                                    ...
                                    <div className="col-12 px-0 align-self-center">
                                        <div className="row mx-0">
                                            ...
                                            <Svg2 />
                                                ...
                                                <div className="text">Crypto Fund</div>
                                                <div className="circle small one"></div>
                                                <div className="circle two"></div>
                                                <div className="circle small three"></div>
                                            ...
                                            <div className="col-10 col-md-8 col-lg-4  col-ld-6 mx-auto">
                                                <h1 className="mb-4"><span className="text-secondary fw-light">MTC<br />
                                                        </span>Crypto Fund!</h1>
                                                <p className="text-secondary"> 
                                                </p>
                                            </div>
                                        ...
                                        <div className="row mx-0">
                                            ...
                                            <div className="col-10 col-md-8 col-lg-4  col-ld-6 mx-auto">
                                                <h1 className="mb-4"><span
                                                        className="text-secondary fw-light">Insurance<br />Coverage For Your</span><br /> Assets!</h1>
